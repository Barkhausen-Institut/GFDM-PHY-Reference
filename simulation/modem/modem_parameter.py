...
class ModemParameter(FrozenBoundedClass):
    def __init__(self):
        ...
        self.receiver_structure= ["sync", "channel_est_eq", "demodulator","resource_demapper", "phase_corrector","qam_demapper","decoder"]
        self.transmitter_structure = ["encoder","qam_mapper","resource_mapper","modulator","add_cp_cs","frame_multiplexer"]
